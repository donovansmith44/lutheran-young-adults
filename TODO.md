...
- Outside face:
  ...
  - BACK panel = contact page — logo, CONTACT eyebrow, QR ("Scan to RSVP"), phone `(614) 556-0607`, email `donovan@lcmsyoungadults.org`, tagline.
...
- RSVP flow: `build.py` regenerates `assets/qr-rsvp.svg` each build from `RSVP_URL` (default mailto to donovan@lcmsyoungadults.org with prefilled subject + body template).
